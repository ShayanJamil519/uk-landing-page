  ...
  return (
    <>
      ...
      <div className=" flex justify-center items-center">
        <div className="w-[90%]  min-h-[224px] lg:h-auto lg:w-[50%] mx-auto   justify-center items-center flex  rounded-[32px] relative">
          <img
            onClick={handleOpen}
            src="/image 5.svg"
            alt="logo"
            className="absolute right-0 top-0 bottom-0  left-0 sm:relative w-full   cursor-pointer  "
          />
